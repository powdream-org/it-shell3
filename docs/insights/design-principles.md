...
| L6 | **Cross-module content migration is rewriting, not copying** | v0.3 (daemon) | Absorbing content from IME/protocol docs into daemon docs introduced 3 headless API violations (V1-01, V1-02, R2-03) — Surface API calls that contradict the daemon's headless architecture. Source text must be *translated* to the target module's architecture, not moved verbatim. |
