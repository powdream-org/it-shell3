...
**Changes from v0.4**: Multi-session client model (Section 5.5), version byte semantics defined (wire format only), ERR_DECOMPRESSION_FAILED removed, active_ prefix convention documented, compression pseudocode updated
...
| `0x00000007` | (reserved) | Reserved for future use |
