...
2. A full I-frame (`frame_type=2`) for each visible pane from the shared ring buffer.
...
3. Processes the I-frame (`frame_type=2`) to render the initial viewport
...
This is immediately followed by an I-frame (`frame_type=2`) for the initial pane.
