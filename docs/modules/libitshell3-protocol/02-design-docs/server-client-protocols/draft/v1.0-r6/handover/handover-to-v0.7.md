...
| Document | Path |
|----------|------|
| Doc 01 (Protocol Overview) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/01-protocol-overview.md` |
| Doc 02 (Handshake) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/02-handshake-capability-negotiation.md` |
| Doc 03 (Session/Pane Mgmt) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/03-session-pane-management.md` |
| Doc 04 (Input/RenderState) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/04-input-and-renderstate.md` |
| Doc 05 (CJK Preedit) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/05-cjk-preedit-protocol.md` |
| Doc 06 (Flow Control) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/06-flow-control-and-auxiliary.md` |

### v0.6 Design Artifacts

| Document | Path |
|----------|------|
| Design Resolutions (resize + health) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/design-resolutions-resize-health.md` |
| Research: tmux resize/health | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/research-tmux-resize-health.md` |
| Research: zellij resize/health | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/research-zellij-resize-health.md` |

### v0.6 Review Notes

| Document | Path |
|----------|------|
| Review Notes 01 (cosmetic, 1 issue) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/review-notes/01-residual-empty-state.md` |
| Review Notes: Consistency (17 issues) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/review-notes/02-cross-document-consistency.md` |
| Review Notes: Owner Review (4 issues) | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/review-notes/03-owner-architectural-review.md` |
| This handover | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r6/handover/handover-to-v0.7.md` |

### v0.5 Handover (predecessor)

| Document | Path |
|----------|------|
| v0.5→v0.6 handover | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r5/handover-for-v06-revision.md` |
| v0.5 identifier consensus | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r5/handover-identifier-consensus.md` |

### IME Interface Contract (cross-reference)

| Document | Path |
|----------|------|
| IME contract v0.5 (current) | `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r5/01-interface-contract.md` |
| IME v0.5→v0.6 handover | `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r5/handover-for-v06-revision.md` |
