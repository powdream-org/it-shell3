...
| File | Location |
|------|----------|
| Protocol v0.4 doc 01 | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/01-protocol-overview.md` |
| Protocol v0.4 doc 02 | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/02-handshake-capability-negotiation.md` |
| Protocol v0.4 doc 03 | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/03-session-pane-management.md` |
| Protocol v0.4 doc 04 | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/04-input-and-renderstate.md` |
| Protocol v0.4 doc 05 | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/05-cjk-preedit-protocol.md` |
| Protocol v0.4 doc 06 | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/06-flow-control-and-auxiliary.md` |
| User's protocol review notes | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/review-notes-01-protocol-overview.md` |
| Protocol-side cross-review notes | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/review-notes-cross-review-ime.md` |
| IME-side cross-review notes | `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r3/review-notes-cross-review.md` |
| IME cross-review report | `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r3/review-report.md` |
| IME handover for v0.4 revision | `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r3/handover-for-v04-revision.md` |
...
```
docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r3/handover-for-v04-revision.md
```
...
1. Create v0.5 directory: `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r5/`
