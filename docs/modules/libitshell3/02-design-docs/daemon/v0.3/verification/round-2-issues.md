...
**Location**: daemon/v0.3/04-runtime-policies.md §6.1, line 286
...
**Location**: daemon/v0.3/01-internal-architecture.md line 476
**Confirmed by**: All 4 verifiers
...
**Location**: daemon/v0.3/02-integration-boundaries.md line 362
**Confirmed by**: All 4 verifiers
