...
**Location**: daemon/v0.3/02-integration-boundaries.md §§4.2, 4.3, 4.4, 4.9
...
**Location**: daemon/v0.3/04-runtime-policies.md §5.3
...
**Location**: daemon/v0.3/04-runtime-policies.md §4.3
...
**Location**: daemon/v0.3/01-internal-architecture.md (lines 424, 476, 763) and daemon/v0.3/02-integration-boundaries.md (line 370)
...
**Location**: daemon/v0.3/04-runtime-policies.md §1 vs protocol/v0.11/01-protocol-overview.md §5.5.3
