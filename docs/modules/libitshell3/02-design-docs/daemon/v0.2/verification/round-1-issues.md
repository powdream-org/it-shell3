...
**Severity**: minor
**Source documents**: `v0.2/02-integration-boundaries.md` (line 3), `v0.2/03-lifecycle-and-connections.md` (line 3)
...
**Severity**: critical
**Source documents**: `v0.2/design-resolutions/01-v0.2-review-note-resolutions.md` Resolution 1 "Affected docs" vs `v0.1/design-resolutions/01-daemon-architecture.md` body (R1 line 55, R3 lines 87–96, R9 line 462)
...
**Severity**: critical
**Source documents**: `v0.2/02-integration-boundaries.md` line 4
**Description**: The link `[Design Resolutions — Daemon Architecture](design-resolutions/01-daemon-architecture.md)` resolves to `v0.2/design-resolutions/01-daemon-architecture.md`, which does not exist. The actual target is `v0.1/design-resolutions/01-daemon-architecture.md`.
**Expected correction**: Update the relative path to `../v0.1/design-resolutions/01-daemon-architecture.md`.
...
**Severity**: critical
**Source documents**: `v0.2/03-lifecycle-and-connections.md` Section 1.6 (~line 119) vs `v0.2/01-internal-architecture.md` Sections 3.2–3.3
...
**Severity**: minor
**Source documents**: `v0.2/design-resolutions/01-v0.2-review-note-resolutions.md` Section 1.5 vs `v0.2/01-internal-architecture.md` Sections 3.2 and 3.3
...
**Severity**: minor
**Source documents**: `v0.2/03-lifecycle-and-connections.md` Section 3.2 (child process exit pseudocode)
