...
- **Source version**: libitshell3-protocol server-client-protocols
  draft/v1.0-r12
- **Source resolution**: owner review (v1.0-r12 cleanup) — ADR 00040
...
ADR 00040 (YAGNI — Remove Compression Header Flag and Capability) removes the
...
| --------------------------------- | -------------------------------------------- | ----------- | ----------------- |
| `03-lifecycle-and-connections.md` | Per-client state table, `capabilities` field | Edit        | ADR 00040         |
