...
**Coordination requirement**: The changes requested here MUST be applied simultaneously and consistently with the corresponding content being added to `libitshell3/02-design-docs/daemon/v0.3` documents. Removing behavioral descriptions from IME contract docs without the daemon docs being ready to receive them would create a gap in the design documentation.
