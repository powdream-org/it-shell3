...
|------|----------|--------|
| Initial review report | `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r3/review-report.md` | `cf0a0fe` |
| IME-side cross-review notes | `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r3/review-notes-cross-review.md` | `7ed134c` |
| Protocol-side cross-review notes | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/review-notes-cross-review-ime.md` | `7ed134c` |
| User's own protocol review notes | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/review-notes-01-protocol-overview.md` | `99ff5b9` |
...
`docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/review-notes-01-protocol-overview.md`
