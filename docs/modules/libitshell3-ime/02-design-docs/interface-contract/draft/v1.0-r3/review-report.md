...
| Doc | Title | Path |
|-----|-------|------|
| 01 | Protocol Overview | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/01-protocol-overview.md` |
| 02 | Handshake & Capability Negotiation | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/02-handshake-capability-negotiation.md` |
| 03 | Session & Pane Management | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/03-session-pane-management.md` |
| 04 | Input & RenderState | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/04-input-and-renderstate.md` |
| 05 | CJK Preedit Protocol | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/05-cjk-preedit-protocol.md` |
| 06 | Flow Control & Auxiliary | `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r4/06-flow-control-and-auxiliary.md` |

### IME Interface Contract v0.3

| Doc | Title | Path |
|-----|-------|------|
| 01 | Interface Contract | `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r3/01-interface-contract.md` |
