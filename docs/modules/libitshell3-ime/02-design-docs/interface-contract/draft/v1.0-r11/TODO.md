# IME Interface Contract v1.0-r11 TODO

> **Unified cycle (Plan 15)**: This revision runs simultaneously with
> daemon-architecture v1.0-r9, daemon-behavior v1.0-r9, and server-client-
> protocols v1.0-r13. Canonical TODO is in
...
- [x] Step 1: Requirements Intake — done (see canonical TODO)
