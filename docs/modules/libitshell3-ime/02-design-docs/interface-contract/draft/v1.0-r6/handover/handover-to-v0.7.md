...
All of these are tracked in `docs/modules/libitshell3-ime/02-design-docs/interface-contract/draft/v1.0-r6/cross-team-requests/01-protocol-composition-state-removal.md`.
...
- `docs/modules/libitshell3/02-design-docs/server-client-protocols/draft/v1.0-r7/research/07-ghostty-preedit-cell-serialization.md` has initial findings, but implementation-level details are needed.
