...
| Situation | committed_text | preedit_text | forward_key | preedit_changed |
|-----------|----------------|--------------|-------------|-----------------|
...
| Korean 한 (add tail consonant) | null | `"한"` | null | true |
| Korean 없 (double tail ㅂㅅ) | null | `"없"` | null | true |
...
| Input method switch with composition (korean_2set->direct) | `"한"` (flush) | null | null | true |
| Input method switch without composition (korean_2set->direct) | null | null | null | false |
