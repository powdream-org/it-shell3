...
> **Status**: Draft v0.2 — reviewed, consensus reached.
> **Supersedes**: [v0.1/01-interface-contract.md](../v1.0-r1/01-interface-contract.md), interface-design.md (deleted, merged here), portions of [04-architecture.md](../../../01-overview/04-architecture.md), and [05-integration-with-libitshell3.md](../../../01-overview/05-integration-with-libitshell3.md).
> **Review participants**: principal-architect, ime-expert, ghostty-expert
> **Changes from v0.1**: See [Appendix C: Changes from v0.1](#appendix-c-changes-from-v01)
