...
pub const delivery = struct {
    ...
    pub const control_channel_writer = @import("delivery/control_channel_writer.zig");
    pub const frame_delivery = @import("delivery/frame_delivery.zig");
...
pub const handlers = struct {
    ...
    pub const lifecycle_dispatcher = @import("handlers/lifecycle_dispatcher.zig");
    pub const session_pane_dispatcher = @import("handlers/session_pane_dispatcher.zig");
    pub const input_dispatcher = @import("handlers/input_dispatcher.zig");
    pub const render_dispatcher = @import("handlers/render_dispatcher.zig");
    pub const ime_dispatcher = @import("handlers/ime_dispatcher.zig");
    pub const flow_control_dispatcher = @import("handlers/flow_control_dispatcher.zig");
